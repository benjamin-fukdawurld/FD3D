#ifndef FD3D_ABSTRACTBEHAVIORCOMPONENT_H
#define FD3D_ABSTRACTBEHAVIORCOMPONENT_H
...
namespace FD3D
{
    class FD_EXPORT AbstractBehaviorComponent : public Component
    {
        public:
            AbstractBehaviorComponent() = default;

            ~AbstractBehaviorComponent() override = default;
...
generateTypeCode(FD3D::AbstractBehaviorComponent);

#endif // FD3D_ABSTRACTBEHAVIORCOMPONENT_H
